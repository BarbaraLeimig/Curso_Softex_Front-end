...
export default function Calculator() {
  ...
  function inputNum(e) {
    // definindo função de como os números clicados estarão dispostos no visor
  ...
  function changeSign() {
    ...
    if (num > 0) {
      ...
      // Math é uma biblioteca JS onde uma de suas funcionalidades converte número negativo em positivo
      setNum(Math.abs(num));
    }
  }

  function operatorHandler(e) {
    // função para definir os operadores matemáticos
  ...
  function calculate() {
    // função para calcular e gerar o resultado ao clicar no botão "="
    if (operator === "/") {
  ...
  return (
    ...
    <div>
      <p><strong>Autora: Bárbara Leimig</strong></p>
    </div>
